...
export function Sidebar({ isOpen, setIsOpen, activeTab }: SidebarProps) {
  ...
  const navItems = [
    ...
    { path: "/admin/academic-setup", label: "Academic Setup", icon: <Building2 className="h-5 w-5" /> },
    { path: "/admin/timetables", label: "Timetables", icon: <CalendarDays className="h-5 w-5" /> },
    { path: "/admin/faculty", label: "Faculty", icon: <UserCog className="h-5 w-5" /> },
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={cn(
          "fixed inset-0 bg-black/40 backdrop-blur-sm z-40 lg:hidden cursor-pointer",
